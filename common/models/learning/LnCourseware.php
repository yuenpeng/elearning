...
class LnCourseware extends BaseActiveRecord
{
    ...
    public function getFileLink($show_name = ""){
        ...
        $url = $tFile->secureLink($file->file_path);
        //$url = ['resource/courseware/view','id'=>$this->kid,'download'=>true];
        return Html::a($show_name ? $show_name : $this->courseware_name,$url,['target'=>'_blank']);
    }
