...
class LnFiles extends BaseActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['cloud_status','file_size','cloud_time','created_at', 'updated_at'], 'integer'],
            [['kid', 'file_md5', 'upload_batch', 'file_extension', 'created_by', 'updated_by'],'string', 'max' => 50],
            [['file_name','mime_type'], 'string', 'max' => 100],
            [['file_path', 'file_dir', 'backup_file_path','thumbnail_url'], 'string', 'max' => 1000],
            [['cloud_adp','manifest_info'],'string'],
    ...
    public function attributeLabels()
    {
        return [
			...
			'cloud_status' => Yii::t('boe', 'cloud_status'),
            'cloud_time' => Yii::t('boe', 'cloud_time'),
            'cloud_adp' => Yii::t('boe', 'cloud_adp'),
