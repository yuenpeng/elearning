...
/**
 * This is the model class for table "eln_boe_make_news".
 *
 * @property string $kid
 ...
 */
class BoeMakeNews extends BoeBaseActiveRecord {
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,title,source,author,category_id,abstract,image_url,has_image,'
