...
/**
 * This is the model class for table "eln_boe_weilog_group".
 *
 * @property string $kid
 ...
 */
class BoeWeilogGroup extends BoeBaseActiveRecord {
    ...
    public function rules() {
        return [
            [['group_name','user_id','user_no'], 'required'],
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('boe', 'boe_weilog_group_kid'),
            'group_name' => Yii::t('boe', 'boe_weilog_group_group_name'),
            'user_id' => Yii::t('boe', 'boe_weilog_group_user_id'),
            'user_no' => Yii::t('boe', 'boe_weilog_group_user_no'),
            'keyword1' => Yii::t('boe', 'boe_weilog_group_keyword'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,group_name,keyword1,user_id,user_no'
