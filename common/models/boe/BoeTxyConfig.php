...
/**
 * This is the model class for table "eln_boe_txy_config".
 *
 * @property string $kid
 ...
 */
class BoeTxyConfig extends BoeBaseActiveRecord {
    ...
    private function getKeyNameMap() {
        return array(
            'txy_short_name' => Yii::t('boe', 'txy_short_name'),
            'txy_full_name' => Yii::t('boe', 'txy_full_name'),
            'txy_begin_date' => Yii::t('boe', 'txy_begin_date'),
			'txy_end_date' => Yii::t('boe', 'txy_end_date'),
