...
/**
 * This is the model class for table "eln_boe_txy_messages".
 *
 * @property string $kid
 ...
 */
class BoeTxyMessages extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('boe', 'boe_txy_messages_kid'),
            'content' => Yii::t('boe', 'boe_txy_messages_content'),
			'user_id' => Yii::t('boe', 'boe_txy_messages_user_id'),
			'orgnization_id' => Yii::t('boe', 'boe_txy_messages_orgnization_id'),
			'is_reply' => Yii::t('boe', 'boe_txy_messages_is_reply'),
			'reply_id' => Yii::t('boe', 'boe_txy_messages_reply_id'),
			'reply_content' => Yii::t('boe', 'boe_txy_messages_reply_content'),
            'recommend_sort1' => Yii::t('boe', 'boe_txy_messages_index_sort'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,user_id,orgnization_id,content,is_reply,reply_id,reply_content,recommend_sort1,recommend_sort2,recommend_sort3,recommend_sort4,recommend_sort5'
