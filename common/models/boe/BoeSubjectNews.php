...
/**
 * This is the model class for table "eln_boe_news".
 *
 * @property string $kid
 ...
 */
class BoeSubjectNews extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return [
            ...
            'subject_id' => Yii::t('boe', 'news_subject_id'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,title,source,author,subject_id,abstract,image_url,has_image,'
