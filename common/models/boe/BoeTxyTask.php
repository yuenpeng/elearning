...
/**
 * This is the model class for table "eln_boe_txy_task".
 *
 * @property string $kid
 ...
 */
class BoeTxyTask extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            'kid' 			=> Yii::t('boe', 'txy_task_kid'),
			'name' 			=> Yii::t('boe', 'txy_task_name'),
			'bg' 			=> Yii::t('boe', 'txy_task_bg'),
			'target' 		=> Yii::t('boe', 'txy_task_target'),
			'is_begin' 		=> Yii::t('boe', 'txy_task_is_begin'),
			'begin_date' 	=> Yii::t('boe', 'txy_task_begin_date'),
			'end_date' 		=> Yii::t('boe', 'txy_task_end_date'),
			'recommend_sort1' 	=> Yii::t('boe', 'txy_task_recommend_sort1'),
			'type' 			=> Yii::t('boe', 'txy_task_type'),
			'type_id' 		=> Yii::t('boe', 'txy_task_type_id'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,name,type_id,bg,target,is_begin,begin_date,end_date,recommend_sort1,type'
