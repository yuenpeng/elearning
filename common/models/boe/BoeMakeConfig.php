...
/**
 * This is the model class for table "eln_boe_make_config".
 *
 * @property string $kid
 ...
 */
class BoeMakeConfig extends BoeBaseActiveRecord {
    ...
    private function getKeyNameMap() {
        return array(
			'monitor_name' => Yii::t('boe', 'monitor_name'),
            'subject_name' => Yii::t('boe', 'subject_name'),
			...
			'course_zy_info' => array('name' => Yii::t('boe', 'course_zy_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
			'group_info' => array('name' => Yii::t('boe', 'group_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
