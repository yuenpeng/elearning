...
/**
 * This is the model class for table "eln_boe_txy_student_status".
 *
 * @property string $kid
 ...
 */
class BoeTxyStudentStatus extends BoeBaseActiveRecord {
    ...
    public static function tableName() {
        return 'eln_boe_txy_student_status';
    }
    ...
    public function attributeLabels() {
        return array(
            'kid' 				=> Yii::t('boe', 'txy_student_status_kid'),
			'student_id' 		=> Yii::t('boe', 'txy_student_status_student_id'),
			'orgnization_id' 	=> Yii::t('boe', 'txy_student_status_orgnization_id'),
			'object_type' 		=> Yii::t('boe', 'txy_student_status_object_type'),
			'body_status' 		=> Yii::t('boe', 'txy_student_status_body_status'),
			'mood_status' 		=> Yii::t('boe', 'txy_student_status_mood_status'),
			'investigator_date' 	=> Yii::t('boe', 'txy_student_status_investigator_date'),
			'investigator_id' 	=> Yii::t('boe', 'txy_student_status_investigator_id'),
