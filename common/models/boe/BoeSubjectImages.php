...
/**
 * This is the model class for table "eln_boe_subject_images".
 *
 * @property string $kid
 ...
 */
class BoeSubjectImages extends BoeBaseActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'eln_boe_subject_images';
    }
    ...
    public function rules() {
        return [
            ...
            [['kid', 'organization_id', 'created_by', 'created_from', 'created_ip', 'updated_by', 'updated_from', 'updated_ip'], 'string', 'max' => 50],
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,title,url,thumb_url,file_size,pic_width,pic_height,organization_id,created_by,created_at';
        }
