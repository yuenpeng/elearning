...
/**
 * Description of BoeDocCategory
 * Boe文库分类的数据模型
 * @date 2016-04-25
 * @author Zhenglk
 */
/**
 * This is the model class for table "eln_boe_doc_category".
 *
 * @property string $kid
...
class BoeDocCategory extends BoeBaseActiveRecord {
