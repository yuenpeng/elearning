...
/**
 * This is the model class for table "{{%boe_mixture_course_group_category}}".
 *
 * @property string $kid
 ...
 */
class BoeMixtureCourseGroupCategory extends \common\base\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%boe_mixture_course_group_category}}';
    }
