...
/**
 * This is the model class for table "eln_boe_resource_category".
 *
 * @property string $kid
 ...
 */
class BoeResourceCategory extends BoeBaseActiveRecord {
    ...
    public static function tableName() {
        return 'eln_boe_resource_category';
    }
    ...
    public function attributeLabels() {
        return [
			...
			'tag' => Yii::t('boe', 'txy_tag'),
            'parent_id' => Yii::t('boe', 'txy_parent_id'),
            'sort' => Yii::t('boe', 'txy_sort'),
            'list_sort' => Yii::t('boe', 'txy_list_sort'),
            'detail_sort' => Yii::t('boe', 'txy_detail_sort'),
            'index_sort' => Yii::t('boe', 'txy_index_sort'),
            'keywords' => Yii::t('boe', 'txy_keywords'),
            'descript' => Yii::t('boe', 'txy_descript'),
            'title' => Yii::t('boe', 'txy_title'),
