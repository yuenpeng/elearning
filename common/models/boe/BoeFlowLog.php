...
/**
 * This is the model class for table "eln_boe_flow_log".
 *
 * @property string $kid
 ...
 */
class BoeFlowLog extends BoeBaseActiveRecord {
    ...
    public function rules() {
        return [
            [['event_id','event_type','event_status_code'], 'required'],
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('boe', 'boe_fl_kid'),
            'event_id' => Yii::t('boe', 'boe_fl_event_id'),
			'event_type' => Yii::t('boe', 'boe_fl_event_type'),
			'event_status_code' => Yii::t('boe', 'boe_fl_event_status_code'),
            'mark' => Yii::t('boe', 'boe_fl_mark'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,event_id,event_type,event_status_code,mark'
