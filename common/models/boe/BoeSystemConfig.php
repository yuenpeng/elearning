...
/**
 * This is the model class for table "eln_boe_system_config".
 *
 * @property string $kid
 ...
 */
class BoeSystemConfig extends BoeBaseActiveRecord {
    ...
    private function getKeyNameMap() {
        return array(
            'site_logo' => Yii::t('boe', 'site_logo'),
            'login_background_image' => Yii::t('boe', 'login_background_image'),
            'slider_info' => array('name' => Yii::t('boe', 'slider_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
            'micro_area_info' => array('name' => Yii::t('boe', 'micro_area_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
            'lesson_recommend_info' => array('name' => Yii::t('boe', 'lesson_recommend_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
            'news_list_ad' => Yii::t('boe', 'news_list_ad'),
            'news_detail_ad' => Yii::t('boe', 'news_detail_ad'),
            'foot_content' => Yii::t('boe', 'foot_content'),
        );
    }
