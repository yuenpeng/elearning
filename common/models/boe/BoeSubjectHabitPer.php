...
/**
 * This is the model class for table "eln_boe_subject_habit_per".
 * @property string $kid
 * @property string $hu_kid
 * @property string $hu_org
 ...
 */
class BoeSubjectHabitPer extends BoeBaseActiveRecord {
    ...
    public static function tableName() {
        return 'eln_boe_subject_habit_per';
    }
    ...
    public function rules() {
        return [
            ...
            [['kid','hu_kid','hu_org','created_by', 'created_from', 'created_ip', 'updated_by', 'updated_from', 'updated_ip'], 'string', 'max' => 50],
			[['study_time','study_time2'], 'number'],
    ...
    public function attributeLabels() {
        return [
            'kid' 				=> Yii::t('boe', 'habit_per_kid'),
			'hu_kid' 			=> Yii::t('boe', 'habit_per_hu_kid'),
			'hu_org' 			=> Yii::t('boe', 'habit_per_hu_org'),
			'count_time' 		=> Yii::t('boe', 'habit_per_count_time'),
            'gold_num' 			=> Yii::t('boe', 'habit_per_gold_num'),
            'study_time' 		=> Yii::t('boe', 'habit_per_study_time'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,hu_kid,hu_org,gold_num,study_time,gold_num2,study_time2,'
