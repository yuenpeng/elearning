 ...
 */
class BoeSubjectWeilog extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('boe', 'boe_subject_weilog_kid'),
            'content' => Yii::t('boe', 'boe_subject_weilog_content'),
            'recommend_status' => Yii::t('boe', 'boe_subject_weilog_recommend'),
            'publish_status' => Yii::t('boe', 'boe_subject_weilog_publish'),
            'like_num' => Yii::t('boe', 'boe_subject_weilog_like'),
            'orgnization_id' => Yii::t('boe', 'boe_subject_weilog_orgnization'),
