...
/**
 * This is the model class for table "eln_boe_txy_manager".
 *
 * @property string $kid
 ...
 */
class BoeTxyManager extends BoeBaseActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'eln_boe_txy_manager';
    }
    ...
    public function attributeLabels() {
        return [
            'kid' 				=> Yii::t('boe', 'txy_manager_kid'),
			'organization_id' 	=> Yii::t('boe', 'txy_manager_organization_id'),
			'user_id' 			=> Yii::t('boe', 'txy_manager_user_id'),
            'level' 			=> Yii::t('boe', 'txy_manager_level'),
            'mark' 				=> Yii::t('boe', 'txy_manager_mark'),
