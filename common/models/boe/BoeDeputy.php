...
/**
 * This is the model class for table "eln_boe_deputy".
 *
 * @property string $kid
 * @property string $user_id_deputy
 ...
 */
class BoeDeputy extends BoeBaseActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['kid','created_by', 'created_ip', 'updated_by', 'updated_from', 'updated_ip'], 'string', 'max' => 1024],
    ...
    public function attributeLabels() {
        return [
            ...
            'user_id_deputy' => Yii::t('boe', 'user_id_deputy'),
			'orgnization_id' => Yii::t('boe', 'orgnization_id'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,user_id_deputy,orgnization_id,version,created_at,created_by,updated_by,updated_at';
        }
