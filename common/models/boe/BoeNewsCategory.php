...
/**
 * This is the model class for table "eln_boe_news_category".
 *
 * @property string $kid
 ...
 */
class BoeNewsCategory extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('boe', 'news_category_kid'),
            'name' => Yii::t('boe', 'news_category_name'),
            'parent_id' => Yii::t('boe', 'news_category_parent_id'),
            'sort' => Yii::t('boe', 'news_category_sort'),
            'list_sort' => Yii::t('boe', 'news_category_list_sort'),
            'detail_sort' => Yii::t('boe', 'news_category_detail_sort'),
            'index_sort' => Yii::t('boe', 'news_category_index_sort'),
            'keywords' => Yii::t('boe', 'news_category_keywords'),
            'descript' => Yii::t('boe', 'news_category_descript'),
            'title' => Yii::t('boe', 'news_category_title'),
...
//                    print_r($php_code . "\$a_info[{$a_key}]={$a_info[$a_key]}{$a_value}tmp_check:{$tmp_check}<br />\n");
    ...
    public function getBaseTree($create_mode = 0, $debug = 0) {
        ...
        if (!$sult) {
            if (!$this->allInfo || $create_mode) {//未初始化全部分类信息时
