...
/**
 * This is the model class for table "eln_boe_make_group_score".
 *
 * @property string $kid
 * @property string $group_no
 * @property string $group_score
 ...
 */
class BoeMakeGroupScore extends BoeBaseActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'eln_boe_make_group_score';
    }
    ...
    public function attributeLabels() {
        return [
			...
			'group_score' 		=> Yii::t('boe', 'make_group_group_score'),
			'group_date' 		=> Yii::t('boe', 'make_group_group_date'),
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,group_no,group_score,group_date,created_by,created_at';
        }
