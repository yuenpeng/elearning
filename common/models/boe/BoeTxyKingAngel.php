...
/**
 * This is the model class for table "eln_boe_txy_king_angel".
 *
 * @property string $kid
 ...
 */
class BoeTxyKingAngel extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            'kid' 			=> Yii::t('boe', 'txy_king_angel_kid'),
			'angel_id' 		=> Yii::t('boe', 'txy_king_angel_angel_id'),
			'king_id' 		=> Yii::t('boe', 'txy_king_angel_king_id'),
			'orgnization_id' => Yii::t('boe', 'txy_king_angel_orgnization_id'),
