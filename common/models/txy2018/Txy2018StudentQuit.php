...
/**
 * This is the model class for table "eln_txy2018_student_quit".
 *
 * @property string $kid
 ...
 */
class Txy2018StudentQuit extends BoeBaseActiveRecord {
    ...
    public static function tableName() {
        return 'eln_txy2018_student_quit';
    }
    ...
    public function rules() {
        return [
            [['user_id','orgnization_id'], 'required'],
    ...
    public function getList($params = array(), $debug = 0) {
        ...
        if (empty($params['select']) && empty($params['field'])) {
            $params['select'] = 'kid,user_id,orgnization_id'. ',created_at,created_by,updated_by,updated_at';
        }
