...
/**
 * This is the model class for table "eln_txy2018_config".
 *
 * @property string $kid
 ...
 */
class Txy2018Config extends BoeBaseActiveRecord {
    ...
    private function getKeyNameMap() {
        return array(
            'txy_short_name' => Yii::t('txy', 'txy_short_name'),
            'txy_full_name' => Yii::t('txy', 'txy_full_name'),
            'txy_begin_date' => Yii::t('txy', 'txy_begin_date'),
			'txy_end_date' => Yii::t('txy', 'txy_end_date'),
			'course_info' => array('name' => Yii::t('boe', 'course_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
			'phpage_info' => array('name' => Yii::t('boe', 'phpage_info'), 'write_func' => 'encode', 'read_func' => 'decode'),
