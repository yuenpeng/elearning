...
/**
 * This is the model class for table "eln_txy2018_news_category".
 *
 * @property string $kid
 ...
 */
class Txy2018NewsCategory extends BoeBaseActiveRecord {
    ...
    public static function tableName() {
        return 'eln_txy2018_news_category';
    }
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('txy', 'txy_kid'),
            'name' => Yii::t('txy', 'txy_name'),
			'tag' => Yii::t('txy', 'txy_tag'),
            'parent_id' => Yii::t('txy', 'txy_parent_id'),
            'sort' => Yii::t('txy', 'txy_sort'),
            'list_sort' => Yii::t('txy', 'txy_list_sort'),
            'detail_sort' => Yii::t('txy', 'txy_detail_sort'),
            'index_sort' => Yii::t('txy', 'txy_index_sort'),
            'keywords' => Yii::t('txy', 'txy_keywords'),
            'descript' => Yii::t('txy', 'txy_descript'),
            'title' => Yii::t('txy', 'txy_title'),
...
//                    print_r($php_code . "\$a_info[{$a_key}]={$a_info[$a_key]}{$a_value}tmp_check:{$tmp_check}<br />\n");
     ...
     */
	 public function getBaseTreeFromTag($tag = '', $debug = 0) {
		  ...
		  $sult		= $sult[$tag_info['parent_id']]['sub_cate'];
		  return $sult[$kid]; 
	 }
