...
/**
 * This is the model class for table "eln_txy2018_weilog".
 *
 * @property string $kid
 ...
 */
class Txy2018Weilog extends BoeBaseActiveRecord {
    ...
    public function attributeLabels() {
        return [
            'kid' => Yii::t('boe', 'boe_txy_weilog_kid'),
            'content' => Yii::t('boe', 'boe_txy_weilog_content'),
            'recommend_status' => Yii::t('boe', 'boe_txy_weilog_recommend'),
            'publish_status' => Yii::t('boe', 'boe_txy_weilog_publish'),
            'like_num' => Yii::t('boe', 'boe_txy_weilog_like'),
            'orgnization_id' => Yii::t('boe', 'boe_txy_weilog_orgnization'),
