 ...
 */
class Txy2018StudentEvent extends BoeBaseActiveRecord {
    ...
    public static function tableName() {
        return 'eln_txy2018_student_event';
    }
    ...
    public function attributeLabels() {
        return array(
            'kid' 			=> Yii::t('txy', 'txy_student_event_kid'),
			'user_id' 		=> Yii::t('txy', 'txy_student_event_user_id'),
			'orgnization_id' => Yii::t('txy', 'txy_student_event_orgnization_id'),
			'is_fhd' 		=> Yii::t('txy', 'txy_student_event_is_fhd'),
			'is_not_course' 	=> Yii::t('txy', 'txy_student_event_is_not_course'),
			'is_not_extend' 	=> Yii::t('txy', 'txy_student_event_is_not_extend'),
			'is_nwbb' 	=> Yii::t('txy', 'txy_student_event_is_nwbb'),
			'is_xlbb' 	=> Yii::t('txy', 'txy_student_event_is_xlbb'),
			'is_hdbb' 	=> Yii::t('txy', 'txy_student_event_is_hdbb'),
			'investigator_date' => Yii::t('txy', 'txy_student_event_investigator_date'),
			'investigator_id' 	=> Yii::t('txy', 'txy_student_event_investigator_id'),
			'image_url' 		=> Yii::t('txy', 'txy_student_event_image_url'),
