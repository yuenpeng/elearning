...
class TxyConfigService {
     ...
     * 获取特训营基础配置信息
     */
    static function getTxyAllConfig($create_mode = 1) {
     ...
     * @return type
     */
    static function getTxyBasicConfig() {
        $all_config = self::getTxyAllConfig();
        $basic_info = array(
     ...
     * @return type
     */
    static function getTxyCourseConfig($area_id = "") {
        $all_config = self::getTxyAllConfig();
        $sult = array();
     ...
     * @return type
     */
    static function getTxyBannerConfig() {
		$all_config = self::getTxyAllConfig();
