            ...
            if (Yii::$app->session->has($sessionKey)) {
                ...
                if (!empty($portalMenu)) {
                    ...
                    foreach ($portalMenu as $menu) {
                        ...
                        if (!empty($actionTip)) {
                            $titleTip = "title='" . $actionTip . "' ";
                        } else {
                            $titleTip = "title='" . Yii::t('data',$action18n) . "' ";
                        }
                        ...
                        if (!empty($actionUrl)) {
                            ...
                            $str .= "<a " . $titleTip . $targetTag . "href='" . $menuSubUrl . "'>" . Yii::t('data',$action18n) . "</a>";
                        } else {
                            $str .= "<a " . $titleTip . $targetTag . "href='#'>" .  Yii::t('data',$action18n)  . "</a>";
                        }
