            ...
            <table border="0" cellpadding="0" width="100%" style="width:100.0%">
                ...
                <tr>
                    <td valign="top" style="padding:.75pt .75pt .75pt .75pt">
                        ...
                        <p>
                            <span style="font-size:10.0pt;">您已经成功报名《<a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['resource/course/view', 'id' => $course->kid, 'from' => 'mail']) ?>"><?=$course->course_name?></a>》课程，请及时参加课程学习，谢谢！</span>
                        </p>
                        <p>
                            <span style="font-size:10.0pt;">您报名的课程《<a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['resource/course/view', 'id' => $course->kid, 'from' => 'mail']) ?>"><?=$course->course_name?></a>》，已经审批通过。开课时间为：<?=date('Y-m-d', $course->open_start_time)?>，地点为：<?=$course->training_address?>，请记得到时参加，谢谢！</span>
                        </p>
                    </td>
                </tr>
            </table>
