            ...
            <table border="0" cellpadding="0" width="100%" style="width:100.0%">
                ...
                <tr>
                    <td valign="top" style="padding:.75pt .75pt .75pt .75pt">
                        ...
                        <p>
                            <span style="font-size:10.0pt;">您已申请报名《<a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['resource/course/view', 'id' => $course->kid, 'from' => 'mail']) ?>"><?=$course->course_name?></a>》课程,请您登录京东方大学平台，补全并确认报名信息，谢谢！</span>
                        </p>
                    </td>
                </tr>
            </table>
