            ...
            <table border="0" cellpadding="0" width="100%" style="width:100.0%">
                ...
                <tr>
                    <td valign="top" style="padding:.75pt .75pt .75pt .75pt">
                        ...
                        <p>
                            <span style="font-size:10.0pt;">您报名的《<a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['resource/course/view', 'id' => $course->kid, 'from' => 'mail']) ?>"><?=$course->course_name?></a>》课程已通过管理员资质审核，请您登陆京东方大学平台，及时上传报名审批凭证，谢谢。</span>
                        </p>
                    </td>
                </tr>
            </table>
