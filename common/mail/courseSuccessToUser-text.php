...
您已经成功报名《<?=$course->course_name?>》课程，请及时参加课程学习，谢谢！

您报名的课程《<?=$course->course_name?>》，已经审批通过。开课时间为：<?=date('Y-m-d', $course->open_start_time)?>，地点为：<?=$course->training_address?>，请记得到时参加，谢谢！
